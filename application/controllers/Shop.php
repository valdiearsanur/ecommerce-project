...
class Shop extends MY_Controller {
	...
	public function user_details() {
		$this->form_validation->set_rules(
				'first_name', 
				$this->lang->line('user_details_placeholder_first_name'), 
		...
		$this->form_validation->set_rules(
				'email_confirm', $this->lang->line('user_details_placeholder_email_confirm'),
				'required|min_length[1]|max_length[255]|valid_email|matches[email]'
				);
		
		$this->form_validation->set_rules(
				'payment_address', 
				$this->lang->line('user_details_placeholder_payment_address'),
				'required|min_length[1]|max_length[1000]'
				);
		
		$this->form_validation->set_rules(
				'delivery_address', 
				$this->lang->line('user_details_placeholder_delivery_address'),
		...
		if ($this->form_validation->run() == FALSE) {
			$data['first_name'] = array(
						...
						'maxlength' => '100', 
						'size' => '35', 
						'placeholder' => $this->lang->line('user_details_placeholder_first_name'));
			...
			$data['last_name'] = array(
						...
						'maxlength' => '100', 
						'size' => '35', 
						'placeholder' => $this->lang->line('user_details_placeholder_last_name'));
			...
			$data['email'] = array(
						...
						'placeholder' => $this->lang->line('user_details_placeholder_email'));
			...
			$data['email_confirm'] = array(
						...
						'maxlength' => '100', 
						'size' => '35', 
						'placeholder' => $this->lang->line('user_details_placeholder_email_confirm'));
			...
			$data['payment_address'] = array(
						...
						'maxlength' => '100',
						'size' => '35', 
						'placeholder' => $this->lang->\line('user_details_placeholder_payment_address'));
			...
			$data['delivery_address'] = array(
						...
						'maxlength' => '100',
						'size' => '35', 
						'placeholder' => $this->lang->line('user_details_placeholder_delivery_address'));
